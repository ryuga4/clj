...
The `home-routes` handler in the `jan.routes.home` namespace
...
The `home-page` function will in turn call the `jan.layout/render` function
...
The rest of this page is rendered by ClojureScript found in the `src/cljs/jan/core.cljs` file.



#### Organizing the routes

The routes are aggregated and wrapped with middleware in the `jan.handler` namespace:
...
Request middleware functions are located under the `jan.middleware` namespace.

This namespace is reserved for any custom middleware for the application. Some default middleware is
already defined here. The middleware is assembled in the `wrap-base` function.

Middleware used for development is placed in the `jan.dev-middleware` namespace found in
